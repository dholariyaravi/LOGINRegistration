...
export default function LoginEMS() {
  ...
  return (
    <div className="clssLOgin">
      ...
      <Link className='btn btn-dark' to={'/register'}>New Registration</Link>
      <hr></hr>

        <div className="container">
          <input type='submit' style={{color:'darkblue'}} href="#" className="btn border-dark txte-white px-5" value='Login' />
       </div>
